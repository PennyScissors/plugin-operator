...
type PluginOperator struct {
	...
	ControllerName string `usage:"Unique name to identify this controller that is added to all UIPlugins tracked by this controller" default:"plugin-operator" env:"CONTROLLER_NAME"`
